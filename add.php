...
try {
    ...
    $commonName = isset($_REQUEST['common_name']) ? strtolower(trim($_REQUEST['common_name'])) : null;
    ...
    $id = $db->add(strtolower(trim($_REQUEST['name'])), $commonName, $description, $imageUrl, $wikiUrl, $answers);
